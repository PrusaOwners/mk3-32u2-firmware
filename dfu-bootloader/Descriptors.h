	...
	/* Macros: */
		...
		#define ARDUINO_MEGA_ADK_PID		0x0044 // R3 (003F R1)
			...
			#define MANUFACTURER_STRING L"Prusa Research (prusa3d.com)"
				...
				#define PRODUCT_STRING L"Original Prusa i3 MK3 DFU"
			#else
				#define PRODUCT_STRING L"Prusa DFU"
			#endif
		#elif (VENDORID == ARDUINO_VID)
			#define MANUFACTURER_STRING L"Arduino"
			#if (PRODUCTID == ARDUINO_UNO_PID)
				#define PRODUCT_STRING L"Arduino Uno DFU"
			#elif (PRODUCTID == ARDUINO_MEGA2560_PID || PRODUCTID == ARDUINO_MEGA_ADK_PID)
				#define PRODUCT_STRING L"Arduino Mega 2560 DFU"
			#else
				#define PRODUCT_STRING L"Arduino DFU"
			#endif
		#else
			#define MANUFACTURER_STRING L"LUFA Library"
			#define PRODUCT_STRING L"LUFA DFU"
		#endif
